...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
 ...
 //public String url=  "http://www.zoftino.com/api/storeOffers";
                ...
                MainActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                          ...
                          //    txtString.setText("First Name: "+json.getJSONObject("data").getString("maxCashback") + "\nLast Name: " + json.getJSONObject("data").getString("store"));

                              txtString.setText("ID: "+json.getJSONObject("data").getString("id")+"\nFirst Name: "+json.getJSONObject("data").getString("first_name") + "\nLast Name: " + json.getJSONObject("data").getString("last_name"));
